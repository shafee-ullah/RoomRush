        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-background-light dark:bg-background-dark rounded-lg shadow-lg overflow-hidden">
                <div className="px-6 py-4 bg-secondary-100 dark:bg-secondary-800 border-b flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-text-light dark:text-text-dark">Available Roommate Listings</h1>
                    <div className="flex items-center space-x-2">
                        <FaSearch className="text-secondary-400 dark:text-secondary-500" />
                        <span className="text-secondary-500 dark:text-secondary-400">{listings.length} listings found</span>
                    </div>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-secondary-200 dark:divide-secondary-700">
                        ...
                        <tbody className="bg-background-light dark:bg-background-dark divide-y divide-secondary-200 dark:divide-secondary-700">
                            {listings.map((listing) => (
                                <tr key={listing._id} className="hover:bg-secondary-50 dark:hover:bg-secondary-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-text-light dark:text-text-dark">{listing.location}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-text-light dark:text-text-dark">{listing.roomType}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-text-light dark:text-text-dark">{listing.userName || 'Anonymous'}</div>
                                    </td>
                ...
                {listings.length === 0 && (
                    <div className="text-center py-8">
                        <p className="text-secondary-500 dark:text-secondary-400 text-lg">No listings available at the moment.</p>
                    </div>
                )}
            </div>
        </div>
