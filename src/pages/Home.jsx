...
const ExtraSections = () => (
  <>
    {/* Why Choose RoomRush Section */}
    <section className="my-20">
      <h3 className="text-3xl font-bold text-center text-text-light dark:text-text-dark mb-12">
        Why Choose <span className="text-primary-600 dark:text-primary-400">RoomRush</span>?
      </h3>
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
          <div className="text-center mb-6">
            ...
            <h4 className="text-xl font-bold mb-2 text-text-light dark:text-text-dark">Trusted Community</h4>
            <p className="text-gray-600 dark:text-gray-400">
              Every roommate undergoes identity verification. View detailed profiles with lifestyle preferences, habits, and rental history. Read and leave authentic reviews for better trust.
            </p>
    ...
    <section className="my-20 bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-gray-800 dark:to-gray-900 py-16 rounded-2xl">
      <h3 className="text-3xl font-bold text-center text-text-light dark:text-text-dark mb-12">
        Find Your Perfect <span className="text-primary-600 dark:text-primary-400">Roommate</span> in 3 Steps
      </h3>
        ...
        <div className="relative">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
            ...
            <div className="text-center pt-4">
              <h4 className="text-xl font-bold mb-4 text-text-light dark:text-text-dark">Create Your Profile</h4>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Build your detailed profile with:
              </p>
